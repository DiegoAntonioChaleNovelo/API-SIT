  ...
  <div class="flex flex-col">
    ...
    <div class="relative">
      <div class="rounded-full border border-black w-16 h-16 relative overflow-hidden">
        <div
          ...
          :style="{ height: `${sistemasData.listas / (sistemasData.listas + sistemasData.faltantes) * 100}%` }"
        >
    ...
    <div class="relative">
      <div class="rounded-full border border-black w-16 h-16 relative overflow-hidden">
        <div
          class="absolute bottom-0 left-0 w-full bg-yellow-500 text-white flex items-center justify-center"
          :style="{ height: `${electromecanicaData.listas / (electromecanicaData.listas + electromecanicaData.faltantes) * 100}%` }">
    ...
    <div class="relative">
      <div class="rounded-full border border-black w-16 h-16 relative overflow-hidden">
        <div
          class="absolute bottom-0 left-0 w-full bg-yellow-500 text-white flex items-center justify-center"
          :style="{ height: `${electronicaData.listas / (electronicaData.listas + electronicaData.faltantes) * 100}%` }">
  ...
  <div class="flex flex-col items-center">
    ...
    <div class="relative">
      <div class="rounded-full border border-black w-16 h-16 relative overflow-hidden">
        <div
          class="absolute bottom-0 left-0 w-full bg-yellow-500 text-white flex items-center justify-center"
          :style="{ height: `${renovablesData.listas / (renovablesData.listas + renovablesData.faltantes) * 100}%` }">
